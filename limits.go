...
// 发送资格查询？
func (cli *Client) GetCappingInfo1(ctx context.Context) (json.RawMessage, error) {
	data, err := cli.sendMexIQ(ctx, queryNewChatMessageCappingInfo, map[string]any{
		"input": map[string]any{
			"type": "MESSAGING_ELIGIBILITY",
		},
	})
	if err != nil {
		return nil, err
...
// 账号质量评分？
func (cli *Client) GetCappingInfo2(ctx context.Context) (json.RawMessage, error) {
	data, err := cli.sendMexIQ(ctx, queryNewChatMessageCappingInfo, map[string]any{
		"input": map[string]any{
			"type": "ACCOUNT_QUALITY",
		},
	})
	if err != nil {
		return nil, err
...
// 账号质量评分？
func (cli *Client) GetCappingInfo3(ctx context.Context) (json.RawMessage, error) {
	data, err := cli.sendMexIQ(ctx, queryNewChatMessageCappingInfo, map[string]any{
		"input": map[string]any{
			"type": "MESSAGE_QUOTA_FORECAST",
		},
	})
	if err != nil {
		return nil, err
